    ...
    <div className="step-content">
      ...
      <div className="info-box" style={{ marginBottom: '16px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div><strong>1.</strong> Connect an LLM provider (Anthropic, OpenAI, etc.)</div>
          <div><strong>2.</strong> Link your Telegram account</div>
          <div><strong>3.</strong> Set up a TON wallet for crypto operations</div>
          <div><strong>4.</strong> Configure behavior and optional modules</div>
        </div>
      </div>
